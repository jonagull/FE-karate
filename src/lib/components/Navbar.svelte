  ...
  >
    ...
    <li class="relative parent">
      ...
      >
        ...
        <li>
          <a href="/kata" class="flex px-4 py-3 hover:bg-gray-50"> Kata </a>
        </li>
        <li>
          <a href="/encyclopedia" class="flex px-4 py-3 hover:bg-gray-50">
            Leksikon
          </a>
        </li>
      </ul>
    ...
    <li class="relative parent">
      ...
      >
        ...
        <li>
          <a href="/boardmember" class="flex px-4 py-3 hover:bg-gray-50">
            Styret
          </a>
        </li>
      </ul>
    ...
    <li class="relative parent">
      ...
      >
        <li>
          <a href="/links" class="flex px-4 py-3 hover:bg-gray-50"> Linker </a>
        </li>
        <li>
          <a href="/gallery" class="flex px-4 py-3 hover:bg-gray-50"> Media </a>
        </li>
        <li>
